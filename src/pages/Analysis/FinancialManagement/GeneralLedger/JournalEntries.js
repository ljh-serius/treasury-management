          ...
          <Grid item xs={12} md={4}>
            <Card>
              <CardContent>
                ...
                <Typography variant="body2">Total debits recorded in journal entries.</Typography>
              </CardContent>
            </Card>
          </Grid>
          <Grid item xs={12} md={4}>
            <Card>
              <CardContent>
                ...
                <Typography variant="body2">Total credits recorded in journal entries.</Typography>
              </CardContent>
            </Card>
          </Grid>
          <Grid item xs={12} md={4}>
