...
export default function ComplianceAuditsAnalytics({ fetchItems }) {
  ...
  const auditStatusDistributionChart = {
    chart: { type: 'pie' },
    title: { text: 'Compliance Audit Status Distribution' },
    series: [
      {
        name: 'Status',
        colorByPoint: true,
      ...
      <Box sx={{ padding: 4 }}>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            <Card>
              <CardContent>
                ...
                <Typography variant="body2">Total number of compliance audits conducted.</Typography>
              </CardContent>
            </Card>
          </Grid>
          <Grid item xs={12} md={4}>
            <Card>
              <CardContent>
                ...
                <Typography variant="body2">Audits still pending completion.</Typography>
              </CardContent>
            </Card>
          </Grid>
          ...
          <Grid item xs={12} md={12}>
            <HighchartsReact highcharts={Highcharts} options={auditStatusDistributionChart} />
          </Grid>
        </Grid>
      </Box>
    </Container>
