...
const CulturalIntegrationAnalytics = ({ fetchItems }) => {
  ...
  const statusChartOptions = {
    chart: { type: 'pie' },
    title: { text: 'Integration Status Distribution' },
    series: [{
      name: 'Status',
      colorByPoint: true,
  ...
  return (
    <Grid container spacing={4}>
      ...
      <Grid item xs={12} md={4}>
        <Card>
          <Typography variant="h6" gutterBottom>Total Cultural Integrations</Typography>
...
export default CulturalIntegrationAnalytics;
