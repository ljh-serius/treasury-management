...
export default function CulturalIntegrationDashboard({ fetchItems }) {
  ...
  const statusChartOptions = {
    chart: { type: 'pie' },
    title: { text: 'Cultural Integration Status Distribution' },
    series: [{
      name: 'Status',
      colorByPoint: true,
  ...
  const timelineChartOptions = {
    chart: { type: 'line' },
    title: { text: 'Cultural Integration Timelines' },
